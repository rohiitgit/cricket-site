    ...
    return (
        <>
            <div className="">
                ...
                >
                    Cricket has the incredible power to unite people from all walks of life, fostering camaraderie, respect, and friendships that stand the test of time. It’s more than just a sport—it's a cultural force that transcends boundaries, bringing together individuals from different backgrounds, languages, and beliefs. Cricket creates a common ground where passion for the game bridges divides and builds lasting connections.
                </div>

                <div className="absolute w-[374px] h-[45px] left-[calc(50%-374px/2-458px)]">
                    <div className="overflow-hidden">
                        <h1 ref={textRef} className="absolute w-[628px] h-[237px] left-[75px] top-[1000px] font-jost font-normal text-[20px] leading-[34px] text-black"
                            data-aos="fade-up"
                        >
                    ...
                    <div ref={imageRef} className="absolute w-[630px] h-[468px] left-[735px] top-[947px] bg-[url('../public/svg/img.svg')]"
                        data-aos="zoom-in"
                    >
