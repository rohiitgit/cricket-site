...
const Footer = () => {
    ...
    return (
        <div className="flex justify-between items-center relative h-auto w-full top-96">
            <div className="relative bg-[#EBEEF3] rounded-l-lg flex"> {/* Only left corners rounded */}
