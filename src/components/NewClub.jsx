...
const NewClub = () => {
  ...
  return (
      <>    
          <div className='flex justify-between items-center gap-9 relative w-full h-auto top-[300px]'>
              <div className='pt-32'>
                  ...
                  <div className='flex gap-8 mt-5'>
                      ...
                      <div data-aos="fade-left" className="p-3 flex flex-col gap-3 w-[297.69px] h-[325.93px] left-[420px] bg-[#EBEEF3] rounded-[6.61539px]">
                          ...
                          <div className="flex gap-4 justify-center items-center" data-aos="zoom-in">
                              <div className="w-[77.18px] h-[76.05px] bg-[url('../public/svg/img3.svg')] rounded-[3.30769px]">
                              </div>
                              <div className="w-[184.13px] h-[39.41px] font-jost font-semibold text-[16px] leading-[20px] text-[#262626]">
                          ...
                          <div className="flex gap-4 justify-center items-center" data-aos="zoom-in">
                              <div className="w-[77.18px] h-[76.05px] bg-[url('../public/svg/img4.svg')] rounded-[3.30769px]">
                              </div>
                              <div className="w-[184.13px] h-[39.41px] font-jost font-semibold text-[16px] leading-[20px] text-[#262626]">
                      ...
                      <div className=" w-[628.46px] h-[292.25px] py-6 px-3">
                          ...
                          <div className='flex mt-6 flex-col gap-5'>
                              ...
                              {clubRankings.map((club, index) => (
                                    <div key={index}>
                                      <div className='relative flex justify-between' data-aos="fade-up">
                                  ...
                                  <div className="w-[310.92px] h-[22.66px] flex gap-8 justify-center items-center ">
                                      ...
                                      <div className='bg-slate-400 h-[1px] opacity-20' data-aos="fade"></div>
                                </div>
                                ))}
