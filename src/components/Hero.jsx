...
const HeroPage = () => {
    ...
    return (
        <div className="container mx-auto flex-col overflow-hidden relative w-full h-auto">
            <nav className="p-4  flex justify-center flex-wrap">
               
                    <Link
                        to="/"
                        className={`${location.pathname === '/' ? 'text-black' : 'text-gray-400'
                    ...
                    <Link
                        to="/about"
                        className={`${location.pathname === '/about' ? 'text-black' : 'text-gray-400'
                            } hover:text-gray-600 px-4 py-2`}
                    ...
                    <Link
                        to="/services"
                        className={`${location.pathname === '/services' ? 'text-black' : 'text-gray-400'
                            } hover:text-gray-600 px-4 py-2`}
                    ...
                    <Link
                        to="/contact"
                        className={`${location.pathname === '/contact' ? 'text-black' : 'text-gray-400'
                            } hover:text-gray-600 px-4 py-2`}
